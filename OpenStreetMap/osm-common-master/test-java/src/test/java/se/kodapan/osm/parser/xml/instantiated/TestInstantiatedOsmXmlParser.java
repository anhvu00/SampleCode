...
//    parser.parse(new InputStreamReader(getClass().getResourceAsStream("/fjallbacka.osm.xml"), "UTF8"));
    parser.parse(new InputStreamReader(getClass().getResourceAsStream("/sample.osm"), "UTF8"));
    System.out.println("nodes="+root.getNodes().size());
    System.out.println("ways="+root.getWays().size());
    System.out.println("relations="+root.getRelations().size());

...
//ATTRIBUTES
	...
	private File testFile_bleru;
	
//SETUP
	@Before
	public void setUp() throws Exception {
		p1 = new OSMParser();
		URL testUrl = getClass().getResource("/xml/sample.osm");
		testFile = new File(testUrl.toURI());
		
		URL testUrl_2 = getClass().getResource("/xml/bleruais.osm");
		testFile_bleru = new File(testUrl_2.toURI());
...
//		assertEquals("Regionalverkehr Küste", r1.getTags().get("operator"));
	...
	public void testParseFile() throws IOException, SAXException {
		result = p1.parse(testFile);
		testSampleFile();
	}
	
	@Test
	public void testParseString() throws IOException, SAXException {
		String osmXml = TestSuite.readTextFile(testFile);
	...
	public void testParseVillage() throws IOException, SAXException {
		result = p1.parse(testFile_bleru);

...
import com.goldsentinel.JsonTest;

public class JsonPatchDiffTest {
	
	private static final Logger LOG = LoggerFactory.getLogger(JsonPatchDiffTest.class);
    ...
    public void testAddDiff() {
        ...
        LOG.info("jsonPatch=" + jsonPatch.toString());
        ...
        LOG.info("patchOperations=" + patchOperations.toString());
    }
    ...
    public void testAddDiffNewObject() {
        ...
        assertNotNull(patch);
        LOG.info("target=" + patch.toString());
